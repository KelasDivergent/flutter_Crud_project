...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.lightBlue[50], // Background color of the Scaffold
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: const Text(
          'Note',
          style:
              TextStyle(color: Colors.white), // Text color of the AppBar title
        ),
        backgroundColor:
            Color.fromARGB(255, 73, 100, 250), // Background color of the AppBar
        actions: [
          IconButton(
            icon: const Icon(Icons.logout),
            color: Colors.white, // Color of the IconButton
            onPressed: () {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromARGB(
            255, 73, 100, 250), // Background color of the FloatingActionButton
